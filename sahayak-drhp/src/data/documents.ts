...
const corporate: RequiredDoc[] = [
  ...
  },
  {
    ...
    extracts: [
      { label: 'Angel Investors', value: 'Kartik Gaikwad, Om Bhorkade' },
      { label: 'Investors', value: 'Sahil Gadam, Khushi Chakke, Vansh Jaiswal' },
...
const financial: RequiredDoc[] = [
  {
    ...
    name: 'Audited Financial Statements — last 3 financial years',
    detail: 'Includes Balance Sheet, Statement of Profit & Loss, Cash Flow Statement, and Notes to Accounts for FY21, FY22, and FY23.',
  ...
  {
    id: 'auditor-report',
    name: "Auditor's Report for each year",
    detail: "Statutory auditor's report for each year, including the CARO annexure on statutory dues, related parties and fixed assets.",
  ...
  {
    id: 'interim-financials',
    name: 'Latest Interim/Stub Financial Statements',
    detail: 'Required if the latest audit report is older than 6 months at the time of filing (e.g. Q3 FY24 statements).',
    basis: 'ICDR Reg. 11 · Interim Disclosures',
    chapters: ['Restated Financial Information'],
    necessity: 'conditional',
    accept: 'PDF',
    sample: 'Stub_Financials_Q3_FY24.pdf',
    extracts: [
      { label: 'Period covered', value: '9 months ended 31 Dec 2023' },
      { label: 'Revenue (interim)', value: '₹39.12 crore' },
      { label: 'PAT (interim)', value: '₹3.40 crore' },
    ],
  },
  {
    id: 'restated-financials',
    name: 'Restated Financial Statements / Restated Financial Information',
    detail: 'Audited accounts re-cast into the format prescribed by SEBI, examined and signed off by peer-reviewed auditor.',
    basis: 'ICDR Schedule VI · Reg. 11(1)',
    chapters: ['Restated Financial Information'],
    necessity: 'mandatory',
    accept: 'PDF',
  ...
  },
  {
    ...
    detail: 'Statement showing movement in share capital, securities premium, and other reserves over the last 3 financial years.',
    basis: 'Companies (Accounts) Rules, 2014',
    chapters: ['Capital Structure', 'Restated Financial Information'],
    necessity: 'conditional',
    accept: 'PDF, XLSX',
    sample: 'Equity_Changes_Statement.xlsx',
    extracts: [
      { label: 'Bonus share details', value: 'Bonus issue in July 2022' },
      { label: 'Reconciles to cap table', value: 'Yes' },
    ],
  },
  {
    id: 'accounting-policies',
    name: 'Accounting policies and significant accounting notes',
    detail: 'Critical accounting principles applied to revenue recognition, inventory valuation, depreciation, and taxation.',
    basis: 'ICDR Schedule VI · Part A',
    chapters: ['Restated Financial Information', 'Other Financial Information'],
    necessity: 'mandatory',
    accept: 'PDF',
    sample: 'Accounting_Policies_Notes.pdf',
    extracts: [
      { label: 'Revenue Recognition', value: 'Ind AS 115 compliant' },
      { label: 'Depreciation method', value: 'Written Down Value' },
    ],
  },
  {
    id: 'related-party-transactions',
    name: 'Related Party Transaction disclosures',
    detail: 'Register of contracts and disclosures of all transactions with promoters, directors, KMPs, and group entities.',
    basis: 'ICDR Schedule VI · Related Party Transactions',
    chapters: ['Other Financial Information', 'History & Corporate Matters'],
    necessity: 'mandatory',
    accept: 'PDF, XLSX',
    sample: 'Related_Party_Transactions_Register.xlsx',
    extracts: [
      { label: 'Director Remuneration', value: 'Fully disclosed' },
      { label: 'Promoter transactions', value: 'Baner facility lease' },
    ],
  },
  {
    id: 'contingent-liabilities',
    name: 'Details of contingent liabilities and commitments',
    detail: 'List of outstanding guarantees, pending litigation claims, and disputed statutory dues / tax demands.',
    basis: 'ICDR Schedule VI · Outstanding Litigation',
    chapters: ['Outstanding Litigation', 'Risk Factors'],
    necessity: 'mandatory',
    accept: 'PDF',
    sample: 'Contingent_Liabilities_FY23.pdf',
    extracts: [
      { label: 'Disputed GST demand', value: '₹18.4 lakh under appeal' },
      { label: 'Corporate guarantees', value: 'None' },
    ],
    flag: {
      tone: 'warn',
      text: 'Disputed GST demand of ₹18.4 lakh is under appeal and must be disclosed under Contingent Liabilities.',
    },
  },
  {
    id: 'borrowings-details',
    name: 'Details of borrowings / loans',
    detail: 'Sanction letters and loan agreements for term loans, working capital limits, and lender NOCs for listing.',
    ...
    extracts: [
      { label: 'Debt outstanding', value: '₹5.40 crore' },
  ...
  },
  {
    ...
    name: 'Fixed asset / property information',
    detail: 'Property ownership records, lease deeds for manufacturing/registered office premises, and fixed asset register.',
    basis: 'ICDR Schedule VI · Material Properties',
    chapters: ['Our Business', 'Material Contracts'],
    necessity: 'mandatory',
    accept: 'PDF',
    sample: 'Fixed_Asset_Register_Lease.pdf',
    extracts: [
      { label: 'Baner Facility Lease', value: '9-year lease registered' },
      { label: 'Plant & Machinery value', value: '₹8.12 crore' },
    ],
  },
]
